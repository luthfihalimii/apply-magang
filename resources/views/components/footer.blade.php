<footer class="text-white">
    {{-- Background + padding luar seperti frame --}}
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                ...
                <div>
                    ...
                    <div class="inline-flex items-center gap-3 bg-white/95 text-gray-800 rounded-lg px-4 py-3">
                        <img
                            src="{{ asset('assets/logo/logo-pti.png') }}"
                            alt="PTI Logo"
                            class="h-9 w-auto"
                        >
                    ...
                    <ul class="mt-8 space-y-3 text-sm text-white/95">
                        <li class="flex items-start gap-3">
                            <img src="{{ asset('assets/icons/location.png') }}" class="w-5 h-5 mt-0.5" alt="">
                        ...
                        <li class="flex items-center gap-3">
                            <img src="{{ asset('assets/icons/email.png') }}" class="w-5 h-5" alt="">
                            <span class="opacity-90">:</span>
                            <span>marketing@piramidati.com</span>
                        </li>

                        <li class="flex items-center gap-3">
                            <img src="{{ asset('assets/icons/phone.png') }}" class="w-5 h-5" alt="">
                            <span class="opacity-90">:</span>
                            <span>031 - 5828 3512</span>
                        </li>

                        <li class="flex items-center gap-3">
                            <img src="{{ asset('assets/icons/whatsapp.png') }}" class="w-5 h-5" alt="">
                            <span class="opacity-90">:</span>
                            <span>085954320729</span>
                        </li>

                        <li class="flex items-center gap-3">
                            <img src="{{ asset('assets/icons/linkedin.png') }}" class="w-5 h-5" alt="">
                            <span class="opacity-90">:</span>
                ...
                <div class="md:pt-2 flex flex-col">
                    ...
                    {{-- Spacer biar card-nya turun ke bawah (seperti desain) --}}
