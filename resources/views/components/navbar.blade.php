...
<header class="sticky top-0 z-50">
  {{-- TOPBAR --}}
  <div class="bg-blue-600 text-white text-[13px]">
  ...
  {{-- MAIN NAV --}}
  <div class="bg-white border-b border-[#DBDBDB]">
    <div class="mx-auto w-[92%] max-w-[1200px] flex items-center justify-between py-3 gap-4">
      ...
      <nav class="flex items-center gap-5 flex-wrap text-[14px]">
        ...
        <div class="relative group">
          ...
          <div
            class="absolute left-0 top-[120%] hidden group-hover:block min-w-[210px] bg-white border border-[#DBDBDB] rounded-xl shadow-lg py-2">
            <a class="block px-4 py-2 hover:bg-slate-50 hover:text-blue-600 {{ $isActive('magang') }}"
               href="{{ url('/magang') }}">Magang</a>
            <a class="block px-4 py-2 hover:bg-slate-50 hover:text-blue-600 {{ $isActive('lowongan') }}"
